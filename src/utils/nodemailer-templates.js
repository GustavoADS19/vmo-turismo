        ...
        return (
            `
                <div style="margin: 0; padding: 24px; background-color: #171717; border-radius: 24px;">
                    ...
                    <p style="margin: 8px 0; color: #E3C94F; font-size: 18px;">Telefone para contato: <b style="color: #FFFFFF;">${obj.telefone}</b></p>
                    ...
                    <p style="margin: 8px 0; color: #E3C94F; font-size: 18px;">Assunto:</p>
                    <b style="font-size: 14px; color: #FFFFFF;">${obj.assunto}</b>
                </div>
            `
        );
    }
